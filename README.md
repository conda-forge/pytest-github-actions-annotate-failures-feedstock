About pytest-github-actions-annotate-failures-feedstock
=======================================================
...
Home: https://pypi.org/project/pytest-github-actions-annotate-failures

Package license: MIT

Summary: pytest plugin to annotate failed tests with a workflow command for GitHub Actions

Development: https://github.com/pytest-dev/pytest-github-actions-annotate-failures
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-github-actions-annotate-failures-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-github-actions-annotate-failures-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
